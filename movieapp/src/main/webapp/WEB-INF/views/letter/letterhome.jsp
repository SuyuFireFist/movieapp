...
<div class="container">          
  ...
  <ul class="pagination">
    ...
    <li class="page-item">
      <a class="page-link" href="<%=request.getContextPath()%>/letter/letterhome?currentPage=${page.startPage-1}" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
    </c:if>
    <c:forEach begin="${page.getStartPage()}" end="${page.getEndPage()}" var="i" step="1">
    <li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/letterhome?currentPage=${i}">${i}</a></li>
    </c:forEach>
    <c:if test="${page.totalPage != page.endPage }">
    <li class="page-item">
      <a class="page-link" href="<%=request.getContextPath()%>/letterhome?currentPage=${page.endPage+1}" aria-label="Next">
